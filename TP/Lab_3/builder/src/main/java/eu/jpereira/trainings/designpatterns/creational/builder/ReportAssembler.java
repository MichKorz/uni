...
public class ReportAssembler
{
	...
	public Report getReport(String type)
	{
		...
		ReportBody reportBody = ReportBodyFactory.createReportBody(type);

		reportBody.addCustomerInfo(saleEntry);
		reportBody.addItems(saleEntry);
